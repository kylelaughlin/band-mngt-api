...
ActiveRecord::Schema.define(version: 20161201022110) do
  ...
  create_table "bands_users", force: :cascade do |t|
    t.integer "band_id"
    t.integer "user_id"
    t.index ["band_id"], name: "index_bands_users_on_band_id", using: :btree
    t.index ["user_id"], name: "index_bands_users_on_user_id", using: :btree
  end
